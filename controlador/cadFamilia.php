...
if (empty($msgErro)) {
    ...
    cadastrarMembros($conexao, $nomeMb1, $nomeMb2, $nomeMb3, $nomeMb4, $nomeMb5, $cpfMb1, $cpfMb2, $cpfMb3, $cpfMb4, $cpfMb5, $dnMb1, $dnMb2, $dnMb3, $dnMb4, $dnMb5, $celMb1, $celMb2, $celMb3, $celMb4, $celMb5);
