...
<body>
    ...
    <div class="container">
        ...
        <form id="formulario" name="formulario" action="../../controlador/cadFamilia.php" enctype="multipart/form-data"
            method="POST" class="row g-3 form-cadastro">
            <div class="col-md-12">
                <label for="inputNome" class="form-label required">Nome da Família</label>
                <input type="text" class="form-control" id="inputNome" name="inputNome" onblur="verifText(this)"
                    placeholder="" value="<?php if (isset($_GET['nomeFamilia'])) echo $_GET['nomeFamilia'] ?>">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" id="inputEmail" name="inputEmail" placeholder="nome@gmail.com"
                    onblur="verifEmail(this)" value="<?php if (isset($_GET['email'])) echo $_GET['email'] ?>">
            </div>

            <div class="col-md-6">
                <label for="inputComunidade" class="form-label required ">Comunidade</label>
                <select class="form-select" id="listaComunidades" name="listaComunidades"
                    onblur="verifComunidade(this)">
            ...
            <div class="box__cadMembros form-group">
                ...
                <div class="box__labels">
                    <div class="box__titulos">
                        <input type="text" class="form-control nome label" id="label-nome"
                            placeholder="Nomes dos Membros" disabled>
                        <input type="text" class="form-control cpf label" id="label-cpf" placeholder="CPFs" disabled>
                        <input type="text" class="form-control dn label" id="label-dn" placeholder="Datas de Nascimento"
                            disabled>
                        <input type="text" class="form-control label-cel label" id="label-cel" placeholder="Celulares"
                            disabled>
                    </div>
                    ...
                    <input type="text" style="width: 50px;" id="qtd_membros" name="qtd_membros" disabled hidden
                        value="<?php if (isset($_GET['qtd_membros'])) echo $_GET['qtd_membros'] ?>">

                    <div class="box__buttonsMembros">
                        <button type="button" onclick="adicionarCampos(false)" id="add"> <svg
                        ...
                        <button type="button" onclick="removerCampos()" id="rem"> <svg
                                xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <div class="box__inputs" id="formulario-membros">
                    <div class="inputs-membro" id="membro1">
                        <input type="text" class="form-control nome" id="inputNomeMb1" name="inputNomeMb1"
                            placeholder="1º Membro" onblur="verifText(this)"
                            value="<?php if (isset($_GET['nomeMb1'])) echo $_GET['nomeMb1'] ?>">

                        <input type="text" class="form-control cpf" id="inputCpfMb1" name="inputCpfMb1"
                            placeholder="000.000.000-00" onfocus="getMaskCpf(id)" onblur="verifCpf(this)"
                            value="<?php if (isset($_GET['cpfMb1'])) echo $_GET['cpfMb1'] ?>">

                        <input type="text" class="form-control dn" id="inputDNMb1" name="inputDNMb1"
                            placeholder="00/00/0000" onfocus="getMaskDN(id)" onblur="verifDN(this)"
                            value="<?php if (isset($_GET['dnMb1'])) echo $_GET['dnMb1'] ?>">
                ...
                <input type="text" id="input_id_familia" name="input_id_familia" placeholder=""
                    value="<?php if (isset($_GET['id_familia'])) echo $_GET['id_familia'] ?>" hidden>
            ...
            <div class="col-md-12 box__buttons">
                <a name="btn-cancelar" id="btn-cancelar" class="btn btn-danger" href="#"
