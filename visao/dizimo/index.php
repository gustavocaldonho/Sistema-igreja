    ...
    <div class="container">
        ...
        <div class="box__btn-group">
            ...
            <div class="box__select">
                <select id="select-mes" class="form-select select-mes" aria-label="Default select example" onchange="atualizarStatus(<?php echo $_SESSION['id_familia'] ?>)">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="box__codigoPix">
                            ...
                            <div id="box__buttons-simulacao">
                                ...
                                <button id="btn-pago" class="btn btn-danger fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $_SESSION['id_familia'] ?>, 0, 1); atualizarStatus(<?php echo $_SESSION['id_familia'] ?>)">Não
                                    Pago</button>

                                <button id="btn-pago" class="btn btn-success fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $_SESSION['id_familia'] ?>, 1, 1); atualizarStatus(<?php echo $_SESSION['id_familia'] ?>)">Pago</button>

                                <button id="btn-pago" class="btn btn-warning fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $_SESSION['id_familia'] ?>, 2, 1); atualizarStatus(<?php echo $_SESSION['id_familia'] ?>)">Pendente</button>
