...
<body>
    ...
    <div class="container">
        ...
        <div class="box__membros-conselho">
            ...
            <div class="button">
                <button type="button" id="btn-addMembro" name="btn-addMembro" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-avisos" data-bs-whatever="@mdo">
