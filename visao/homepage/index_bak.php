...
<body>
    ...
    <div class="container">
        ...
        <div class="box__cards">
            ...
            <div class="box__cards-title">
                <h3 class="text-center">Notícias & Avisos</h3>
            </div>
            <div class="box__cards-body">

                <div class="card text-black bg-light mb-3" style="max-width: 15rem;">
                    <div class="card-header">Header</div>
                    <div class="card-body">
                        <h5 class="card-title">Dark card title</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi inventore
                            vitae obcaecati maxime excepturi ex ut, sam temporibus?</p>
                    </div>
                </div>
                ...
                <!-- <div class="card text-black bg-light mb-3" style="max-width: 15rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Dark card title</h5>
                        <p class="card-text">Lorem ipsum dolor siing elit. Animi inventore
                            vitae obcaecati maxime excepturi ex ut, dolores tempore laboriosam temporibus?</p>
                    </div>
                </div>
                ...
                <div class="card text-black bg-light mb-3" style="max-width: 15rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Dark card title</h5>
                        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi inventore
                            vitae obcaecati maxime excepturi ex utporibus?</p>
                    </div>
                </div>
                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body card-body-evento">
                                <div class="box__dia-evento">
                                    <p>06</p>
                                </div>
                                <div class="box__info-evento">
                                    <p>Comunidade: Lorem, ipsum dolor.</p>
                                    <p>Horário: 19:00</p>
                                    <p>Celebrante: Lorem, ipsum dolor.</p>
                                    <p>Paticipação especial de: Lorem ipsum dolor sit amet consectetur.</p>
                                </div>
