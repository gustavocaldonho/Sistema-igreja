...
<body>
    ...
    <div class="container">
        ...
        <form id="formulario" name="formulario" action="../../controlador/cadFamilia.php" method="POST"
            class="row g-3 form-cadastro">
            <div class="col-md-12">
            ...
            <div class="box__cadMembros form-group">
                ...
                <div class="box__labels">
                    ...
                    <div class="box__buttonsMembros">
                        ...
                        <!-- <button type="button" onclick="removerCampos()" id="rem">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <input type="number" id="controleCampos" name="controleCampos" value="1">
