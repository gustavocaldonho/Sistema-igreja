    ...
    <div class="container">
        ...
        <div class="box__btn-group">
            ...
            <div class="box__select">
                <select id="select-mes" class="form-select select-mes" aria-label="Default select example" onchange="buscarStatusSelect(<?php echo $id_familia ?>)">
        ...
        <div class="box__button">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalPagamento" onclick="resetarModalPagamento()">Fazer
                Pagamento</button>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="box__infosPagamento">
                            ...
                            <button id="btn-gerarPix" type="button" class="btn btn-success mt-3" onclick="visualizarQRcode(); efetuarPagamentoDizimo(000, <?php echo $id_familia ?>, 1, 0); ">Gerar
                                Pix</button>
                        ...
                        <div id="box__codigoPix">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button id="botaoCopia" class="btn btn-secondary fs-6" onclick="copiarCodigo()">Copiar</button>
                            </div>
                            <div id="box__buttons-simulacao">

                                <button id="btn-pago" class="btn btn-danger fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $id_familia ?>, 0, 1); atualizarStatusPagina('0')">Não
                                    Pago</button>

                                <button id="btn-pago" class="btn btn-success fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $id_familia ?>, 1, 1); atualizarStatusPagina('1')">Pago</button>

                                <button id="btn-pago" class="btn btn-warning fs-6" onclick="alterarStatusPagamentoDizimo(999, <?php echo $id_familia ?>, 2, 1); atualizarStatusPagina('2')">Pendente</button>
